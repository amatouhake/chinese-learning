...
export const PRACTICE_CATALOG = {
  ...
  pronunciation: {
    ...
    learnerName: "発音",
    mode: "pronunciation",
    purpose: "ピンイン、声調、聞き取り、発話を活動ごとに低い負担で確かめる。",
    interaction: "選択問題は客観正誤、漢字→ピンインは自己申告の想起、発話は答えと比べて完了する。",
    evidence: ["フォーカス", "活動", "客観正誤", "自己申告の想起", "完了項目"],
    doesNotMeasure: ["活動をまたいだ単一の発音点数", "録音音声の自動採点"],
    affectsFsrs: false,
    configuration: ["フォーカス", "問題数"],
    resultMetrics: ["完了数", "活動内訳", "客観正誤", "自己申告の想起", "要確認項目"],
    useWhen: "読みと音を結び付けたい、声調を聞き分けたい、発音を自己確認したいとき。",
    setupDescription: "読み・声調・聞き取りを混ぜ、発話と声調の組み合わせは専用練習で確かめます。",
  },
  reading: {
    id: "reading",
    learnerName: "読解",
    ...
    interaction: "例文を読み、必要な手掛かりを段階的に開いて、その文の完了を記録する。",
    evidence: ["完了文", "遭遇した文法トピック"],
  ...
  grammar: {
    ...
    learnerName: "読解・文法",
    mode: "grammar",
    purpose: "文法トピックを例文と客観問題で理解し、選択結果を記録する。",
    interaction: "解説と例文を読み、選択問題に答えてフィードバックを確認し、その問題を完了する。",
    evidence: ["文法トピック", "客観正誤", "完了項目"],
    doesNotMeasure: ["自由作文能力", "読解全体をまとめた合成点"],
    affectsFsrs: false,
    configuration: ["項目数", "任意のフォーカストピック"],
    resultMetrics: ["完了数", "客観正誤", "要確認トピック"],
